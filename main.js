...
planNextButton.addEventListener('click',function(){
  document.querySelector('.step-container:nth-child(2) span').classList.remove('circle-highlight');
  document.querySelector('.step-container:nth-child(3) span').classList.add('circle-highlight')
...
planBackButton.addEventListener('click',function(){
  document.querySelector('.step-container:nth-child(2) span').classList.remove('circle-highlight');
  document.querySelector('.step-container:nth-child(1) span').classList.add('circle-highlight')
  document.getElementById('plan').style.display = 'none';
  document.getElementById('personal-info').style.display = 'grid';
})

addonsNextButton.addEventListener('click',function(){
  document.querySelector('.step-container:nth-child(3) span').classList.remove('circle-highlight');
  document.querySelector('.step-container:nth-child(4) span').classList.add('circle-highlight')
...
addonsBackButton.addEventListener('click',function(){
  document.querySelector('.step-container:nth-child(3) span').classList.remove('circle-highlight');
  document.querySelector('.step-container:nth-child(2) span').classList.add('circle-highlight')
  document.getElementById('addOns').style.display = 'none';
...
summaryBackButton.addEventListener('click',function(){
  document.querySelector('.step-container:nth-child(4) span').classList.remove('circle-highlight');
  document.querySelector('.step-container:nth-child(3) span').classList.add('circle-highlight')
  document.getElementById('summary').style.display = 'none';
  document.getElementById('addOns').style.display = 'grid';
  removeAddons();
...
for(let checkBox of checkBoxes){
  checkBox.addEventListener('change',function(){
    if(this.checked == true){
      ...
      document.querySelector(`fieldset[id="${this.value}"]`).classList.add('border-blue') 
    }else{
      listArr = listArr.filter(ele=>ele!==this.value)
      document.querySelector(`fieldset[id="${this.value}"]`).classList.remove('border-blue')
    }  
  }) 
}
...
const showSuccess = (input) => {
    ...
    if (isFormValid) {
    document.querySelector('.step-container span').classList.remove('circle-highlight');
    document.querySelector('.step-container:nth-child(2) span').classList.add('circle-highlight')
